...
np.save('results/final_results/SSM/acc_densenet121.npy',Y_pred_acc)
np.save('results/final_results/SSM/gyro_densenet121.npy',Y_pred_gyro)
np.save('results/final_results/SSM/fused_densenet121.npy',Y_pred)
...
np.save('results/final_results/SSM/acc_densenet169.npy',Y_pred_acc)
np.save('results/final_results/SSM/gyro_densenet169.npy',Y_pred_gyro)
np.save('results/final_results/SSM/fused_densenet169.npy',Y_pred)
...
np.save('results/final_results/SSM/acc_densenet201.npy',Y_pred_acc)
np.save('results/final_results/SSM/gyro_densenet201.npy',Y_pred_gyro)
np.save('results/final_results/SSM/fused_densenet201.npy',Y_pred)
...
np.save('results/final_results/SSM/acc_densenet161.npy',Y_pred_acc)
np.save('results/final_results/SSM/gyro_densenet161.npy',Y_pred_gyro)
np.save('results/final_results/SSM/fused_densenet161.npy',Y_pred)