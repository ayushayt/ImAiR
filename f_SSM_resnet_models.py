...
np.save('results/final_results/SSM/acc_resnet18.npy',Y_pred_acc)
np.save('results/final_results/SSM/gyro_resnet18.npy',Y_pred_gyro)
np.save('results/final_results/SSM/fused_resnet18.npy',Y_pred)
...
np.save('results/final_results/SSM/acc_resnet34.npy',Y_pred_acc)
np.save('results/final_results/SSM/gyro_resnet34.npy',Y_pred_gyro)
np.save('results/final_results/SSM/fused_resnet34.npy',Y_pred)
...
np.save('results/final_results/SSM/acc_resnet50.npy',Y_pred_acc)
np.save('results/final_results/SSM/gyro_resnet50.npy',Y_pred_gyro)
np.save('results/final_results/SSM/fused_resnet50.npy',Y_pred)
...
np.save('results/final_results/SSM/acc_resnet101.npy',Y_pred_acc)
np.save('results/final_results/SSM/gyro_resnet101.npy',Y_pred_gyro)
np.save('results/final_results/SSM/fused_resnet101.npy',Y_pred)
...
np.save('results/final_results/SSM/acc_resnet152.npy',Y_pred_acc)
np.save('results/final_results/SSM/gyro_resnet152.npy',Y_pred_gyro)
np.save('results/final_results/SSM/fused_resnet152.npy',Y_pred)
