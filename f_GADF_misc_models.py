...
np.save('results/final_results/GADF/acc_googlenet.npy',Y_pred_acc)
np.save('results/final_results/GADF/gyro_googlenet.npy',Y_pred_gyro)
np.save('results/final_results/GADF/fused_googlenet.npy',Y_pred)
...
np.save('results/final_results/GADF/acc_alexnet.npy',Y_pred_acc)
np.save('results/final_results/GADF/gyro_alexnet.npy',Y_pred_gyro)
np.save('results/final_results/GADF/fused_alexnet.npy',Y_pred)
