...
np.save('results/final_results/GADF/acc_resnet18.npy',Y_pred_acc)
np.save('results/final_results/GADF/gyro_resnet18.npy',Y_pred_gyro)
np.save('results/final_results/GADF/fused_resnet18.npy',Y_pred)
...
np.save('results/final_results/GADF/acc_resnet34.npy',Y_pred_acc)
np.save('results/final_results/GADF/gyro_resnet34.npy',Y_pred_gyro)
np.save('results/final_results/GADF/fused_resnet34.npy',Y_pred)
...
np.save('results/final_results/GADF/acc_resnet50.npy',Y_pred_acc)
np.save('results/final_results/GADF/gyro_resnet50.npy',Y_pred_gyro)
np.save('results/final_results/GADF/fused_resnet50.npy',Y_pred)
...
np.save('results/final_results/GADF/acc_resnet101.npy',Y_pred_acc)
np.save('results/final_results/GADF/gyro_resnet101.npy',Y_pred_gyro)
np.save('results/final_results/GADF/fused_resnet101.npy',Y_pred)
...
np.save('results/final_results/GADF/acc_resnet152.npy',Y_pred_acc)
np.save('results/final_results/GADF/gyro_resnet152.npy',Y_pred_gyro)
np.save('results/final_results/GADF/fused_resnet152.npy',Y_pred)
