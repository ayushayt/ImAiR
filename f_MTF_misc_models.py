...
np.save('results/final_results/MTF/acc_alexnet.npy',Y_pred_acc)
np.save('results/final_results/MTF/gyro_alexnet.npy',Y_pred_gyro)
np.save('results/final_results/MTF/fused_alexnet.npy',Y_pred)
...
np.save('results/final_results/MTF/acc_googlenet.npy',Y_pred_acc)
np.save('results/final_results/MTF/gyro_googlenet.npy',Y_pred_gyro)
np.save('results/final_results/MTF/fused_googlenet.npy',Y_pred)
