...
np.save('results/final_results/MTF/acc_resnet18.npy',Y_pred_acc)
np.save('results/final_results/MTF/gyro_resnet18.npy',Y_pred_gyro)
np.save('results/final_results/MTF/fused_resnet18.npy',Y_pred)
...
np.save('results/final_results/MTF/acc_resnet34.npy',Y_pred_acc)
np.save('results/final_results/MTF/gyro_resnet34.npy',Y_pred_gyro)
np.save('results/final_results/MTF/fused_resnet34.npy',Y_pred)
...
np.save('results/final_results/MTF/acc_resnet50.npy',Y_pred_acc)
np.save('results/final_results/MTF/gyro_resnet50.npy',Y_pred_gyro)
np.save('results/final_results/MTF/fused_resnet50.npy',Y_pred)
...
np.save('results/final_results/MTF/acc_resnet101.npy',Y_pred_acc)
np.save('results/final_results/MTF/gyro_resnet101.npy',Y_pred_gyro)
np.save('results/final_results/MTF/fused_resnet101.npy',Y_pred)
...
np.save('results/final_results/MTF/acc_resnet152.npy',Y_pred_acc)
np.save('results/final_results/MTF/gyro_resnet152.npy',Y_pred_gyro)
np.save('results/final_results/MTF/fused_resnet152.npy',Y_pred)
