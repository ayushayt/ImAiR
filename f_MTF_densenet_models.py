...
transformer = MarkovTransitionField(strategy='uniform')
...
predictions1 = single_model(X_train_final_acc, X_val_final_acc, Y_train_final_acc, Y_val_final_acc,X_test_ssm_acc,Y_test,'densenet121')
predictions2 = single_model(X_train_final_gyro, X_val_final_gyro, Y_train_final_gyro, Y_val_final_gyro,X_test_ssm_gyro,Y_test,'densenet121')
...
Y_pred = np.argmax(np.asarray(predictions),axis=1)
print('densenet121 : Accelerometer = ' + str(accuracy_score(Y_test,Y_pred_acc)) + ' Gyroscope = ' + str(accuracy_score(Y_test,Y_pred_gyro)) + ' Fused = ' + str(accuracy_score(Y_test,Y_pred)))
np.save('results/final_results/MTF/acc_densenet121.npy',Y_pred_acc)
np.save('results/final_results/MTF/gyro_densenet121.npy',Y_pred_gyro)
np.save('results/final_results/MTF/fused_densenet121.npy',Y_pred)

predictions1 = single_model(X_train_final_acc, X_val_final_acc, Y_train_final_acc, Y_val_final_acc,X_test_ssm_acc,Y_test,'densenet169')
predictions2 = single_model(X_train_final_gyro, X_val_final_gyro, Y_train_final_gyro, Y_val_final_gyro,X_test_ssm_gyro,Y_test,'densenet169')
predictions = np.asarray(predictions1+predictions2)
Y_pred_acc = np.argmax(np.asarray(predictions1),axis=1)
Y_pred_gyro = np.argmax(np.asarray(predictions2),axis=1)
Y_pred = np.argmax(np.asarray(predictions),axis=1)
print('densenet169 : Accelerometer = ' + str(accuracy_score(Y_test,Y_pred_acc)) + ' Gyroscope = ' + str(accuracy_score(Y_test,Y_pred_gyro)) + ' Fused = ' + str(accuracy_score(Y_test,Y_pred)))
np.save('results/final_results/MTF/acc_densenet169.npy',Y_pred_acc)
np.save('results/final_results/MTF/gyro_densenet169.npy',Y_pred_gyro)
np.save('results/final_results/MTF/fused_densenet169.npy',Y_pred)

predictions1 = single_model(X_train_final_acc, X_val_final_acc, Y_train_final_acc, Y_val_final_acc,X_test_ssm_acc,Y_test,'densenet201')
predictions2 = single_model(X_train_final_gyro, X_val_final_gyro, Y_train_final_gyro, Y_val_final_gyro,X_test_ssm_gyro,Y_test,'densenet201')
predictions = np.asarray(predictions1+predictions2)
Y_pred_acc = np.argmax(np.asarray(predictions1),axis=1)
Y_pred_gyro = np.argmax(np.asarray(predictions2),axis=1)
Y_pred = np.argmax(np.asarray(predictions),axis=1)
print('densenet201 : Accelerometer = ' + str(accuracy_score(Y_test,Y_pred_acc)) + ' Gyroscope = ' + str(accuracy_score(Y_test,Y_pred_gyro)) + ' Fused = ' + str(accuracy_score(Y_test,Y_pred)))
np.save('results/final_results/MTF/acc_densenet201.npy',Y_pred_acc)
np.save('results/final_results/MTF/gyro_densenet201.npy',Y_pred_gyro)
np.save('results/final_results/MTF/fused_densenet201.npy',Y_pred)

predictions1 = single_model(X_train_final_acc, X_val_final_acc, Y_train_final_acc, Y_val_final_acc,X_test_ssm_acc,Y_test,'densenet161')
predictions2 = single_model(X_train_final_gyro, X_val_final_gyro, Y_train_final_gyro, Y_val_final_gyro,X_test_ssm_gyro,Y_test,'densenet161')
predictions = np.asarray(predictions1+predictions2)
Y_pred_acc = np.argmax(np.asarray(predictions1),axis=1)
Y_pred_gyro = np.argmax(np.asarray(predictions2),axis=1)
Y_pred = np.argmax(np.asarray(predictions),axis=1)
print('densenet161 : Accelerometer = ' + str(accuracy_score(Y_test,Y_pred_acc)) + ' Gyroscope = ' + str(accuracy_score(Y_test,Y_pred_gyro)) + ' Fused = ' + str(accuracy_score(Y_test,Y_pred)))
np.save('results/final_results/MTF/acc_densenet161.npy',Y_pred_acc)
np.save('results/final_results/MTF/gyro_densenet161.npy',Y_pred_gyro)
np.save('results/final_results/MTF/fused_densenet161.npy',Y_pred)