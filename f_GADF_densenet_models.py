...
np.save('results/final_results/GADF/acc_densenet121.npy',Y_pred_acc)
np.save('results/final_results/GADF/gyro_densenet121.npy',Y_pred_gyro)
np.save('results/final_results/GADF/fused_densenet121.npy',Y_pred)
...
np.save('results/final_results/GADF/acc_densenet169.npy',Y_pred_acc)
np.save('results/final_results/GADF/gyro_densenet169.npy',Y_pred_gyro)
np.save('results/final_results/GADF/fused_densenet169.npy',Y_pred)
...
np.save('results/final_results/GADF/acc_densenet201.npy',Y_pred_acc)
np.save('results/final_results/GADF/gyro_densenet201.npy',Y_pred_gyro)
np.save('results/final_results/GADF/fused_densenet201.npy',Y_pred)
...
np.save('results/final_results/GADF/acc_densenet161.npy',Y_pred_acc)
np.save('results/final_results/GADF/gyro_densenet161.npy',Y_pred_gyro)
np.save('results/final_results/GADF/fused_densenet161.npy',Y_pred)