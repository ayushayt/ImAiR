...
np.save('results/final_results/GAF/acc_alexnet.npy',Y_pred_acc)
np.save('results/final_results/GAF/gyro_alexnet.npy',Y_pred_gyro)
np.save('results/final_results/GAF/fused_alexnet.npy',Y_pred)
...
np.save('results/final_results/GAF/acc_googlenet.npy',Y_pred_acc)
np.save('results/final_results/GAF/gyro_googlenet.npy',Y_pred_gyro)
np.save('results/final_results/GAF/fused_googlenet.npy',Y_pred)
