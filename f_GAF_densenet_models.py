...
np.save('results/final_results/GAF/acc_densenet121.npy',Y_pred_acc)
np.save('results/final_results/GAF/gyro_densenet121.npy',Y_pred_gyro)
np.save('results/final_results/GAF/fused_densenet121.npy',Y_pred)
...
np.save('results/final_results/GAF/acc_densenet169.npy',Y_pred_acc)
np.save('results/final_results/GAF/gyro_densenet169.npy',Y_pred_gyro)
np.save('results/final_results/GAF/fused_densenet169.npy',Y_pred)
...
np.save('results/final_results/GAF/acc_densenet201.npy',Y_pred_acc)
np.save('results/final_results/GAF/gyro_densenet201.npy',Y_pred_gyro)
np.save('results/final_results/GAF/fused_densenet201.npy',Y_pred)
...
np.save('results/final_results/GAF/acc_densenet161.npy',Y_pred_acc)
np.save('results/final_results/GAF/gyro_densenet161.npy',Y_pred_gyro)
np.save('results/final_results/GAF/fused_densenet161.npy',Y_pred)